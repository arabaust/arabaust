...
<head>
    ...
    <style type="text/css">
        ...
        /* Preferably not the same color as the normal header link color.  There is
         * limited support for psuedo classes in email clients, this was added just for
         * good measure. */
        ...
        }/* Body text color for the New Yahoo.  This example sets the font of Yahoo's
			 * Shortcuts to black. */
        /* This most probably won't work in all email clients. Don't include <code
         * _tmplitem="786" > blocks in email. */
        code {
            white-space: normal;
...
<center>
<body style="margin: 0;mso-line-height-rule: exactly;padding: 20px;min-width: 100%;background-color: #dfe5e9">
...
<style type="text/css">
    ...
    .wrapper .one-col-feature p a:hover, .wrapper .one-col-feature ol a:hover, .wrapper .one-col-feature ul a:hover {
        color: #006ea6 !important;
        border-bottom: 1px solid #006ea6 !important
    }
    ...
    .wrapper .btn a {
        ...
        text-shadow: 0 1px 0 #3b7db6
    }

    .wrapper .btn a:hover {
        background-color: #3b7db6 !important;
        color: #fff !important;
        outline-color: #3b7db6 !important
    }
    ...
    .footer .social .social-text:hover, .footer .social
    a:hover {
        color: #737373 !important
    }
...
<table width="776" cellpadding="0"  cellspacing="0" border="0" valign="top">
    <tr>
        <td>
            
        
<div class="wrapper"
     style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #dfe5e9">
    ...
    <table class="header centered"
           style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 776px">
        <tbody>

        <tr>
            <td id="header" class="logo" bgcolor="#adc302"
                style="width: 100%;padding: 32px 0;vertical-align: top;mso-line-height-rule: at-least;font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e;font-family: sans-serif">
                <div class="logo-center" style="text-align: center" align="center"
                     id="emb-email-header">
                    <a href="{{ $app['config']['app.url'] }}"> <img id="customHeaderImage" label="Header Image" editable="true" width="119" height="120" src="{{ $app['config']['app.url'] }}/img/email.png" class="w640" border="0" align="top" style="display: inline"/> </a>
                </div>
            </td>
        </tr>
        </tbody>
    ...
    <table class="border"
           style="border-collapse: collapse;border-spacing: 0;font-size: 1px;line-height: 1px;background-color: #cfd5d9;Margin-left: auto;Margin-right: auto"
           width="602">
        <tbody>
        <tr>
    ...
    <table bgcolor="#ffffff" class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto; width: 776px;">
        <tbody>
        <tr>
            <td class="border"
                style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #cfd5d9;width: 1px">
                &#8203;</td>
            <td style="padding: 0;vertical-align: top">
                <table class="one-col"
                                ...
                                <tr>
                                    <td class="padded"
                                        ...
                                        <p style="Margin-top: 0;color: #565656;font-family: sans-serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
                                            Regards,
                                            <br>
                                            <strong>{{ $app['config']['app.name'] }}. </strong>
                                        </p>
                                    </td>
                                </tr>
                                </tbody>
                    ...
                    <tr>
                        <td class="address"
                            ...
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                ...
                                <tr>
                                    <td class="padded"
                                        style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;text-align: left;font-size: 12px;line-height: 20px;color: #999;font-family: sans-serif">
                                        <div>{{ date('Y', time()) }} © {{ $app['config']['app.name'] }}</div>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <td class="subscription"
                            ...
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                ...
                                <tr>
                                    <td class="padded"
                                        style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;font-size: 12px;line-height: 20px;color: #999;font-family: sans-serif;text-align: right">
